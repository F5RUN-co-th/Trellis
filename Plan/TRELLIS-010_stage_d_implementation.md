...
| **D-0.5** | **[MC-1] In-sample §0 CEILING GATE:** enumerate ทั้ง 8 configs full-sample เทียบ §0 — in-sample = upper bound ของ WF/OOS ใดๆ → ceiling < §0 = SKIP-only ตายตั้งแต่ตรงนี้ ไม่เผา WF/PBO/MQL5 | ceiling ≥ §0 จึงเดิน D-1a | **✅ รันแล้ว 2026-07-05 — GATE ยิง: ceiling ดีสุด = CS+PS: loseImp 32.4% · poolImp 9.5% < §0 (50%/30%) → SKIP-only = documented-dead → branch WS-3** |
