...
- **▶ Step 2 (in progress):** build `EdgeDistribution` dataset (counterfactual behavior) → measure edge (4-leg + eval_ruin + Discovery×Execution + Calibration + Edge-Stability) · mirror-fade kill-test
